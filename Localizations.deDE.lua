-- German translations. Thanks to Stellschraube, Sekorhex, d4mich4, and badphish on Curse
...
L["Activate profile %s?"] = "Profil %s aktivieren?"
L[ [=[Activate spec %s?
...
L["Activate your profile."] = "Aktiviere dein Profil."
L["Activating Loadout"] = "Loadout aktivieren"
L["Any"] = "Alle"
L["Are you sure you wish to delete the set \"%s\", this set is in use by one or more profiles. This cannot be reversed."] = "Bist du dir sicher, dass du das Set \"%s\" löschen willst, dieses Set wird von einem oder mehreren Profilen verwendet. Der vorgang kann nicht rückgängig gemacht werden."
...
L["Cata"] = "Cataclysm"
L["Change the name of your new profile."] = "Ändere den Namen des neuen Profiels"
...
L["Create a talent set for your new profile."] = "Erstelle ein Talent-Set für dein neues Profil."
L["Delete"] = "Löschen"
L["Dungeons"] = "Dungeons"
L["Enabled"] = "Aktiviert"
